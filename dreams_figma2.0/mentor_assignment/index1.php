...
<body>
    ...
    <form class="wrapper" action="./index.php" method="post"  onsubmit="show_alert()">
        <div class="asgnmt-title-wrapper">
            <h3>Assignment Title</h3>
             <textarea placeholder="Enter the title here" name="title" rows="1"></textarea required> 
        </div>
        <div class="asgnmt-deadline-wrapper">
            <h3>Deadline</h3>
            <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <image id="image0_156_108" width="90" height="90" xlink:href="data:image/png;base64,"/>
                </defs>
                </svg>            
            <input type="date" placeholder="Enter the deadline here" name="deadline" required>
        </div>
        <div class="asgnmt-year-dropdown">
            <h3>Year</h3>
        ...
        <div class="asgnmt-desc-wrapper">
            <h4>Assignment Description</h4>           
            <textarea name="description" id="" cols="10" rows="3" placeholder="Enter the description here"></textarea
                required>
        </div>
                ...
                <div class="col"> 
                    <div class="card mt-5">
                        <div class="card-header"> 
                            <h2 class="display-5 text-center">Recent Assignments </h2>
                        </div>
                            <div class="card-body">
