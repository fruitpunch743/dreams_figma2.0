...
<body>
        <div class="header pd-0">
          ...
          <h2 class="logout"><button type="button" onclick = "location.href ='http://localhost/dreams_figma2.0/dreams_figma2.0/mentee_course_materials/logout.php';">Logout</button></h2>
      </div>
    <div class="col">
