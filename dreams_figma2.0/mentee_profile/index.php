...
<body>
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border="2">
        ...
        <tr>
            <th>First Year</th>
            <td style="padding-bottom:0px;"><input name="first" type="text" value="<?php echo $row["first"]?>"></td>
        </tr>
        <tr>
            <th>Second Year</th>
            <td style="padding-bottom:0px;"><input name="second" type="text" value="<?php echo $row["second"]?>"></td>
        </tr>
        <tr>
            <th>Third Year</th>
            <td style="padding-bottom:0px;"><input name="third" type="text" value="<?php echo $row["third"]?>"></td>
        </tr>
    </table>
